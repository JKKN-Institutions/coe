...
- **Default form width**: `sm:max-w-[800px]`
- **Narrow forms** (few fields): `sm:max-w-[600px]`
- **Wide forms** (many columns): `sm:max-w-[1000px]`
- **Full-width forms**: `max-w-full`
		...
		<div className="flex items-center gap-3">
			...
			<div>
				...
				<p className="text-sm text-muted-foreground mt-1">
					{editing ? "Update record information" : "Create a new record"}
				</p>
			</div>
		</div>
	</div>
...
<div className="space-y-2">
	...
	/>
	{errors.field_name && (
		<p className="text-xs text-destructive">{errors.field_name}</p>
	)}
</div>
```
...
toast({
	...
	description: `${recordName} has been successfully created.`,
...
toast({
	...
	description: `${recordName} has been successfully updated.`,
	className: "bg-green-50 border-green-200 text-green-800 dark:bg-green-900/20 dark:border-green-800 dark:text-green-200"
})
...
function MyComponent({ title, isLoading = false, onSubmit }: ComponentProps) {
...
function useForm<T>(initialData: T, validationRules?: ValidationRules): UseFormReturn<T> {
...
This comprehensive guide should be followed for all development work to ensure consistency, maintainability, and quality across the entire codebase.
