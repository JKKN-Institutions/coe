						...
						<CardContent className="pt-6">
							<div className="rounded-md border">
								<Table>
									<TableHeader>
										<TableRow>
											<TableHead className="text-[11px]">Program Code</TableHead>
											<TableHead className="text-[11px]">Program Name</TableHead>
										...
										{loading ? (
											...
											paginatedAssociations.map((assoc) => (
												<TableRow key={assoc.id}>
													<TableCell className="text-[11px] font-medium">{assoc.program_code}</TableCell>
													<TableCell className="text-[11px]">{assoc.programs?.program_name || "-"}</TableCell>
