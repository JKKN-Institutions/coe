...
export default function AttendanceCorrectionPage() {
	...
	const handleSearch = async () => {
		...
		try {
			setSearching(true)
			const res = await fetch(`/api/exam-management/attendance-correction?course_code=${encodeURIComponent(selectedCourseCode)}&register_no=${encodeURIComponent(registerNo.trim())}`)
